...
<head>
  ...
  <title>Trend Vault | Checkout</title>
  ...
  <main class="checkout-page">
    <div class="checkout-shell">
      <div class="checkout-header">
        ...
        <a class="continue-link" href="cart.php">Back to Cart</a>
      </div>
      <div class="checkout-grid">
        <form id="checkout-form" class="checkout-form" method="POST" action="place_order.php">
          <label>Full Name
        ...
        <aside>
          ...
          <div class="checkout-total-box">Total <span>₱<span id="checkout-total">0.00</span></span></div>
        </aside>
      </div>
    </div>
  </main>
